...
\newsection{Non-Functional Requirements Evaluation} \label{Section_NFR_Evaluation}
	...
	\subsection{Robustness, Maintainability, and Compatibility}
		...
		\nfrtc {8}
			...
			{Only the top \tplink{HIGH\_SCORE\_CAPACITY} records with the highest score were displayed on the \href{run:../Design/MG/MG.pdf}{RipScreen} module; the rest of the records were internally acknowledged but otherwise ignored.}
		...
		\nfrtc {13}
			...
			{All valid records were processed displayed on the \href{run:../Design/MG/MG.pdf}{RipScreen} module; the nonsensical records were internally acknowledged but otherwise ignored.}
